...
(function() {
    ...
    LC.LiterallyCanvas = function() {
        ...
        LiterallyCanvas.prototype.end = function(x, y) {
            var newPos;
            newPos = this.clientCoordsToDrawingCoords(x, y); // scale the position
            if (this.isDragging) {
		...
		// Jeisern : Shape Saving
        LiterallyCanvas.prototype.saveShape = function(shape) {
            this.execute(new LC.AddShapeAction(this, shape)); // push to the stack
...
(function() {
    ...
    // removed  the undo,redo,clear,zoom in, zoom out button , remove background control, make into 1 row instead of 2
	LC.toolbarHTML = '   <div class="toolbar-row">   <div class="toolbar-row-right">      <div class="tools button-group"></div>           <div class="color-square background-picker">&nbsp;</div>    </div>  <div class="toolbar-row-left">      <div class="color-square primary-picker"></div>      <div class="color-square secondary-picker"></div>      <div class="tool-options-container"></div>    </div>    <div class="clearfix"></div>  </div>';
...
// Jeisern : All draw start and end event caller for different tool are here.
(function() {
